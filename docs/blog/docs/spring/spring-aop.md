...
![AspectJExpressionPointcut类图](/images/blog/spring/AspectJExpressionPointcut.jpg)
...
![aopalliance包](/images/blog/spring/aopalliance.png)
...
![DefaultBeanFactoryPointcutAdvisor类图](/images/blog/spring/DefaultBeanFactoryPointcutAdvisor.jpg)
...
![RuntimeBeanReference类图](/images/blog/spring/RuntimeBeanReference.jpg)
...
![DeclareParentsAdvisor类图](/images/blog/spring/DeclareParentsAdvisor.jpg)

#### 其它

此处的其它指的是aop:before, aop:after等最核心的标签。其最终被解析为beanClass为AspectJPointcutAdvisor的BeanDefinition，类图:

![AspectJPointcutAdvisor类图](/images/blog/spring/AspectJPointcutAdvisor.jpg)
...
![MethodLocatingFactoryBean类图](/images/blog/spring/MethodLocatingFactoryBean.jpg)
...
![SimpleBeanFactoryAwareAspectInstanceFactory类图](/images/blog/spring/SimpleBeanFactoryAwareAspectInstanceFactory.jpg)
...
![AspectJAwareAdvisorAutoProxyCreator类图](/images/blog/spring/AspectJAwareAdvisorAutoProxyCreator.jpg)
...
![AOP逻辑图](/images/blog/spring/aop_logic.jpg)
...
![TargetSource类图](/images/blog/spring/TargetSource.jpg)
...
![ScopedProxyBeanDefinitionDecorator类图](/images/blog/spring/ScopedProxyBeanDefinitionDecorator.jpg)
...
![ScopedProxyFactoryBean类图](/images/blog/spring/ScopedProxyFactoryBean.jpg)
...
![DelegatingIntroductionInterceptor类图](/images/blog/spring/DelegatingIntroductionInterceptor.jpg)
...
![Callback类图](/images/blog/spring/Callback.jpg)
...
![CallbackFilter类图](/images/blog/spring/CallbackFilter.jpg)
...
![Cglib调用流程](/images/blog/spring/cglib_invocation.png)
