...
![Comparator继承体系](/images/blog/spring/Comparator.jpg)
...
![ContextAnnotationAutowireCandidateResolver类图](/images/blog/spring/ContextAnnotationAutowireCandidateResolver.jpg)

### ConfigurationClassPostProcessor

此类用于处理标注了@Configuration注解的类。类图:

![ConfigurationClassPostProcessor类图](/images/blog/spring/ConfigurationClassPostProcessor.jpg)

### AutowiredAnnotationBeanPostProcessor

此类便用于对标注了@Autowire等注解的bean或是方法进行注入。

![AutowiredAnnotationBeanPostProcessor类图](/images/blog/spring/AutowiredAnnotationBeanPostProcessor.jpg)
...
![CommonAnnotationBeanPostProcessor类图](/images/blog/spring/CommonAnnotationBeanPostProcessor.jpg)
...
![EventListenerMethodProcessor类图](/images/blog/spring/EventListenerMethodProcessor.jpg)

### DefaultEventListenerFactory

此类应该是和上面的配合使用，用以产生EventListener对象，也是从Spring4.2加入，类图:

![DefaultEventListenerFactory类图](/images/blog/spring/DefaultEventListenerFactory.jpg)
...
![CompositeComponentDefinition类图](/images/blog/spring/CompositeComponentDefinition.jpg)

最终形成的数据结构如下图:

![数据结构](/images/blog/spring/context_annotation_stack.png)
...
![ImportAwareBeanPostProcessor类图](/images/blog/spring/ImportAwareBeanPostProcessor.jpg)
...
![BeanNameGenerator类图](/images/blog/spring/BeanNameGenerator.jpg)
...
![@Required测试](/images/blog/spring/@required_test.png)
...
![ScopeMetadataResolver类图](/images/blog/spring/ScopeMetadataResolver.jpg)
...
![MetadataReader类图](/images/blog/spring/MetadataReader.jpg)
...
![AnnotationMetadataReadingVisitor类图](/images/blog/spring/AnnotationMetadataReadingVisitor.jpg)
...
![ScannedGenericBeanDefinition类图](/images/blog/spring/ScannedGenericBeanDefinition.jpg)
...
![PropertyOverrideBeanDefinitionParser类图](/images/blog/spring/PropertyOverrideBeanDefinitionParser.jpg)
...
![PropertyOverrideConfigurer类图](/images/blog/spring/PropertyOverrideConfigurer.jpg)
...
![PropertySourcesPlaceholderConfigurer类图](/images/blog/spring/PropertySourcesPlaceholderConfigurer.jpg)
...
![LoadTimeWeaver继承体系](/images/blog/spring/LoadTimeWeaver.jpg)
...
![AspectJWeavingEnabler类图](/images/blog/spring/AspectJWeavingEnabler.jpg)
...
![AnnotationBeanConfigurerAspect类图](/images/blog/spring/AnnotationBeanConfigurerAspect.jpg)
...
![LoadTimeWeaverAwareProcessor类图](/images/blog/spring/LoadTimeWeaverAwareProcessor.jpg)
...
![ClassPreProcessorAgentAdapter类图](/images/blog/spring/ClassPreProcessorAgentAdapter.jpg)
...
![aop.xml解析结果](/images/blog/spring/aop_xml_parse.png)
