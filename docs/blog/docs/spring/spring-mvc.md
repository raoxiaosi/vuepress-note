...
![DispatcherServlet类图](/images/blog/spring/DispatcherServlet.jpg)
...
![ApplicationContextInitializer类图](/images/blog/spring/ApplicationContextInitializer.jpg)
...
![XmlWebApplicationContext类图](/images/blog/spring/XmlWebApplicationContext.jpg)
...
![mvc-annotation](/images/blog/spring/mvc-annotation.png)
...
![MultipartResolver类图](/images/blog/spring/MultipartResolver.jpg)
...
![ThemeResolver类图](/images/blog/spring/ThemeResolver.jpg)
...
![RequestToViewNameTranslator类图](/images/blog/spring/RequestToViewNameTranslator.jpg)
...
![FlashMapManager类图](/images/blog/spring/FlashMapManager.jpg)
...
![RequestMappingHandlerMapping类图](/images/blog/spring/RequestMappingHandlerMapping.jpg)
...
![MappingRegistry类图](/images/blog/spring/MappingRegistry.jpg)
...
![HandlerMethodMappingNamingStrategy类图](/images/blog/spring/HandlerMethodMappingNamingStrategy.jpg)
...
![MappedInterceptor类图](/images/blog/spring/MappedInterceptor.jpg)

## HandlerAdapter初始化

同样，我们以RequestMappingHandlerAdapter为例进行说明，类图:

![RequestMappingHandlerAdapter类图](/images/blog/spring/RequestMappingHandlerAdapter.jpg)
...
![HandlerMethodArgumentResolver类图](/images/blog/spring/HandlerMethodArgumentResolver.jpg)
...
![HandlerMethodReturnValueHandler类图](/images/blog/spring/HandlerMethodReturnValueHandler.jpg)
...
![ParameterNameDiscoverer](/images/blog/spring/ParameterNameDiscoverer.jpg)
...
![本地变量表](/images/blog/spring/local_variable_tables.PNG)

但是默认情况下javac compiler是不生成本地变量表这种调试信息的，需要加`-g`参数才可以，那为什么在我们的测试Controller中却可以获得呢，玄机就在于idea的下列设置:

![idea编译设置](/images/blog/spring/idea_debug_info.PNG)

取消这项设置的勾选再次运行程序便出问题了:

![调试信息错误](/images/blog/spring/debug_info_error.PNG)
...
![BindingAwareModelMap类图](/images/blog/spring/BindingAwareModelMap.jpg)
...
![ModelAndView类图](/images/blog/spring/ModelAndView.jpg)
...
![ViewResolver类图](/images/blog/spring/ViewResolver.jpg)
...
![JstlView类图](/images/blog/spring/JstlView.jpg)
...
![HttpMessageConverter](/images/blog/spring/HttpMessageConverter.jpg)
...
![Spring MVC输入输出转换](/images/blog/spring/mvc_input_output.PNG)

HandlerMethodArgumentResolver接口及其主要实现类如下图:

![HandlerMethodArgumentResolver](/images/blog/spring/HandlerMethodArgumentResolver_all.jpg)

HandlerMethodReturnValueHandler接口以及主要实现类如下:

![HandlerMethodReturnValueHandler](/images/blog/spring/HandlerMethodReturnValueHandler_all.jpg)
...
![ServletModelAttributeMethodProcessor](/images/blog/spring/ServletModelAttributeMethodProcessor.jpg)
...
![DataBinder](/images/blog/spring/DataBinder.jpg)

WebDataBinderFactory接口用以创建WebDataBinder对象，其继承体系如下图:

![WebDataBinderFactory](/images/blog/spring/WebDataBinderFactory.jpg)
...
![Validator](/images/blog/spring/Validator.png)
